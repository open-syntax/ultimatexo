...
export default function RoomsPage() {
  ...
  return (
    <DefaultLayout>
      <h1 className="before:bg-default-400 after:bg-default-400 relative mx-auto mb-8 w-full max-w-md text-center text-xl font-semibold before:absolute before:top-1/2 before:left-16 before:h-px before:w-1/4 before:translate-y-1/2 before:content-[''] after:absolute after:top-1/2 after:right-16 after:h-px after:w-1/4 after:translate-y-1/2 after:content-['']">
        Rooms
      </h1>
